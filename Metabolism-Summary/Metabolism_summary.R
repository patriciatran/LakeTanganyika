...
pdf("~/Box/PhD/Research/Lake-Tanganyika/1_Code/Metabolism-Summary/Metabolism-plots-by-category-LT.pdf", width = 16 , height = 10, title = "Lake Tanganyika MAGs and Metabolism")
