...
# This is the part you can change for each folder (24 folders respectively)

setwd("~/Documents/JGI-LakeTanganyika-Globus-Data/TA2MahsurfametaG_5_FD/")
...
# Product names had the most bumber of rows
# Let's check the distribution of % ID
pdf(file = paste0(filename,".pdf"),   # The directory you want to save the file in
...
ggsave(paste0(filename,".binned.bar.plot.pdf"))
...
write_delim(combined, paste0(filename,".combined.tsv"), delim="\t")
write_delim(coverage.mapped, paste0(filename,"coverage.mapped.tsv"), delim="\t")
