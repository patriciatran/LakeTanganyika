sqr_list <- read.table("~/Box/PhD/Research/Lake-Tanganyika/1_Code/Cyano-vs-SQR-genomes/list_SQR.txt", sep="\t", header=TRUE)
cov.all.mags <- read.table("~/Box/PhD/Research/Lake-Tanganyika/1_Code/Cyano-vs-SQR-genomes/coverage_all_MAGS.tsv", sep="\t", header=TRUE)
...
sample.lookup <- read.table("~/Box/PhD/Research/Lake-Tanganyika/1_Code/Cyano-vs-SQR-genomes/sample_look_up.tsv", header=TRUE, sep="\t")
...
abundance.mags <- read.table("~/Box/PhD/Research/Lake-Tanganyika/1_Code/Cyano-vs-SQR-genomes/coverage_all_MAGS.tsv", header=T, sep="\t")
