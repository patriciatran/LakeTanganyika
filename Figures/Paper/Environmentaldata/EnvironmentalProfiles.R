...
# Plot some environmental data to explore
...
# KD can be estimated by dividing 1.7 by the secchi depth.
...
# Plotting the thermocline over time using rLakeAnalyzer:
...
# Making contour plot for OXYGEN
library(dplyr)
